          ...
          <div class="container">
            ...
            <div class="nav-collapse collapse">
              <ul class="nav">
                ...
                <li><a href="${config.feed_file}" target="_blank">RSS Subscribe</a></li>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="https://github.com/JavaMoney/jsr354-api-bp" target="_blank">Specification (API): Backport to Java 6 (API BP)</a></li>
