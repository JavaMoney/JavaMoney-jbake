<#include "header.ftl">
	...
	<div class="page-header">
        ...
        <section id="main_content">
	        <h3>What is JavaMoney?</h3>
    	    <p>JavaMoney is the new monetary API for the Java&trade; Platform as well as related projects and libraries.
    	    Whereas the API (JSR 354) provides a portable and extensible API for handling of Money &amp; Currency
			...
			<p>
			 Check out the reference implementation <a href="ri.html">here</a>.
			</p>
			<h3>Technical Compatibility Kit (TCK)</h3>
			<p>
			 Want to write your own implementation of JSR 354? Then you should also checkout and configure the TCK. Start <a href="tck.html">here</a>.
			</p>
