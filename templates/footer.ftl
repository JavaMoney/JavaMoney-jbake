    ...
    <div id="footer">
      <div class="container">
        ...
        <p class="muted credit">&copy; 2016 JavaMoney | Mixed with <a href="http://twitter.github.com/bootstrap/">Bootstrap v2.3.1</a> | Baked with <a href="http://jbake.org">JBake ${version}</a></p>
      </div>
    </div>
